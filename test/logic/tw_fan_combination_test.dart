...
void main() {
  ...
  group('Pure One Suit combinations', () {
    test('Pure bamboo all-chow hand detects: isPureHand + isPingHu + isConcealedDragon + hasEyeOf258', () {
      // 1s2s3s 4s5s6s 7s8s9s 1s2s3s + 5s5s
      final hand = ['1s', '2s', '3s', '4s', '5s', '6s', '7s', '8s', '9s', '1s', '2s', '3s', '5s', '5s'];
    ...
    test('Pure bamboo all-pong hand detects: isPureHand + isAllPongs', () {
      ...
      final hand = ['1s', '1s', '1s', '3s', '3s', '3s', '5s', '5s', '5s', '7s', '7s', '7s', '9s', '9s'];
      expect(HandPatterns.isPureHand(hand), isTrue);
  ...
  group('Mixed One Suit combinations', () {
    test('Mixed bamboo + honors all-pong hand detects: isMixedOneSuit + isAllPongs', () {
      // 1s1s1s 5s5s5s 9s9s9s 5z5z5z + 7s7s
      final hand = ['1s', '1s', '1s', '5s', '5s', '5s', '9s', '9s', '9s', '5z', '5z', '5z', '7s', '7s'];
  ...
  group('Wind pattern combinations', () {
    ...
    test('Big Four Winds also triggers Small Four Winds (controller handles exclusion)', () {
      final hand = ['1z', '1z', '1z', '2z', '2z', '2z', '3z', '3z', '3z', '4z', '4z', '4z', '1m', '1m'];
      expect(HandPatterns.isBigFourWinds(hand), isTrue);
