...
void main() {
  ...
  group('Big Three Dragons vs Small Three Dragons', () {
    ...
    test(
      'Hand with 2 dragon triplets + dragon pair triggers Small but NOT Big',
      () {
  ...
  group('Big Four Winds vs Small Four Winds', () {
    test(
      'Hand with 4 wind triplets triggers Big AND Small (controller must prune Small)',
      () {
    ...
    test(
      'Hand with 3 wind triplets + wind pair triggers Small but NOT Big',
      () {
