...
void main() {
  ...
  group('HandPatterns.isEightPairs', () {
    test('valid eight pairs (17 tiles with seven pairs + one triple) → true', () {
      // 1m×3 (counts as 1 pair) + 7 more pairs = 8 pairs
      final tiles = [
        '1m', '1m', '1m', '3m', '3m', '5p', '5p', '9p', '9p',
        '2s', '2s', '7s', '7s', '1z', '1z', '3z', '3z',
      ];
